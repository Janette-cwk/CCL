...
class FullTextPreview extends Component {
    constructor() {
        super();
        // this.state = {
        //     percentage: 0
    ...
    render() {
        ...
        if (page.contents[0].content && this.state.text != page.contents[0].content) {
            this.setState({ text: page.contents[0].content, setText: true});
        }
        let count = 0;
        let pageIdx;
        ...
        console.log(course.sections[sectionIndex].pages.length - 1)
        console.log(course.sections.length - 1)
