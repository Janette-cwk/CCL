...
class FullVideoPreview extends Component {
    ...
    render() {
        ...
        console.log(page.contents[0].content);
        if (page.contents[0].content && this.state.videoEmbeddingCode != page.contents[0].content) {
            console.log("wemadeit");
            this.setState({ videoEmbeddingCode: page.contents[0].content, setVideo: true});
        }
        console.log(this.state.percentage);
        console.log(course.sections.reduce((sum, obj) => sum + obj.pages.length, 0));
        let count = 0;
        let pageIdx;
