...
class MultiImgCapPreview extends Component {
    constructor(props) {
        super(props)
    }
    state = {
    ...
    render() {
        ...
        if (page.contents[0]) {
            for(let i = 0; i < 3; i++) {
                if(page.contents[0].content[i] != this.state.files[i]) {
                                    ...
                                    <div className="img-part" id="div-1">
                                        <Row >
                                            {this.state.files.map((f, idx) =>
                                                <Col md={4} key={idx}>
                                                    <img className="img-upload" style={{marginLeft: "0px", width: "160px", marginTop: "0px"}} src={this.state.files[idx]} />
                                                </Col>
                                            )}
                                        </Row>
                                    </div>
...
export default MultiImgCapPreview;